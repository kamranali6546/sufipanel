               ...
               // echo $payDate;
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-condensed consentNEW"  width="100%">
                            <tr class="trStyle">
                                <td colspan="12" class="hedingTd" style="border-top:none;"><label style="font-size:14px;"><u>Booking Log:</u></label></td>
                            </tr>  
                            <tr>
                                <td colspan="9">
                    ...
                    <div class="col-md-12 table-responsive">
                        ...
                        <table class="table table-condensed consentNEW"  width="100%" style="background-color: #ece9e987;">
                            <tr class="trStyle" style="background: white !important;">
                                <td colspan="12" class="hedingTd"><label style="font-size:14px;"><u>Booking Details:</u></label></td>
                            </tr>
                            <tr>
                            ...
                            <tr class="trStyle" style="background: white !important;">
                                <td colspan="12" class="hedingTd"><label style="font-size:14px;"><u>Customer Contacts:</u></label></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="text-left">
                            ...
                            <tr class="trStyle" style="background: white !important;">
                                <td colspan="12" class="hedingTd"><label style="font-size:14px;"><u>Flight Details:</u></label></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="text-left">
                            ...
                            <tr style="background: white !important;">
                                <td colspan="12">
                                    <div class="ticket_detail" style="color: black;margin-left: 22%;" >
                                          <?php //echo '<pre style="padding: 0px;background: none;">'; 
                                          echo $obj->ticketDetails;  //echo '</pre>'; ?>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
                        ...
                        <table class="table table-condensed consentNEW"  width="100%">
                                        ...
                                        ?>
                                         ...
                                         <tr id="cardRow" style="    background-color: #ece9e987;">
                                                <td colspan="3" class="text-left">
                                                 ...
                                                 <td colspan="3">
                                                     <label><?php echo $card->card_number; ?></label>
                                                 </td>
                                                <td colspan="3" class="text-left">
                                                    <label class="label">Issuing Bank:</label>
                                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="9">
                                   ...
                                   <?php if($lastCardId >0){ ?> <button type="button" class="btn btn-primary pull-right" onclick="editOldCard(<?php echo $lastCardId ?>)" >Edit Old Card</button> <?php } ?>
                                </td> 
                            </tr>
                            <?php } 
                              else{ ?> 
                                    ...
                                    <table class="table tablColor table-condensed" width="100%"  style="    margin-bottom: 4px;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;padding-left: 0px;"><label class="label">Receipt in Via</label></th>
                                                <th style="text-align: center;padding-left: 0px;"><label class="label">Receipt Date</label></th> 
                                                <th style="text-align: center;padding-left: 0px;"><label class="label">Card Last four nos</label></th> 
                                                <th style="text-align: center;padding-left: 0px;"><label class="label">Amount Received (&pound;) </label></th>
                                                <th></th>
                                                <?php if($this->session->userdata('flag')==1){ ?>
                                        ...
                                        <tr id="paymentRecord<?php echo $paymentObj->id; ?>">
                                          ...
                                          <?php   if($this->session->userdata('flag')==1){ ?>
                                            <td <?php if($obj->flag==1){ } else{ ?> style="display: none" <?php } ?> style="text-align: center;">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="6" style="border-top: 0px solid #ddd;"><?php echo $paymentObj->description; ?></td>
                                        </tr>
                                        <?php } } ?>
                                        <?php 
                                        $refunndTotal=0;
                                        if(!empty($CustomerRefund))
                                        {
                                            ...
                                            {
                                                if($refundObj->payment_nature!='Card Charges'){
...
//                                        echo "</pre>";
                                ...
                                ?>
                                        ...
                                        <?php 
                                            ...
                                            { if($supplierObj->pay_by!='Customer'){
                                                $amountPayedSupplier=$amountPayedSupplier-$supplierObj->amount;
                                                ?>
                                                    <tr id="supplierRecord<?php echo $supplierObj->id; ?>">
                                            <td style="text-align:center !important;"><?php  echo $supplierObj->transectionId; ?></td>
...
<!--                                        <button type="button" class="btn btn-primary btn-round">Payment & Other Request</button>
                                        ...
                                        <?php if($this->session->userdata('flag')==1){
                                            ...
                                            ?>
                                                ...
                                                <?php } ?>
                                                <a class="btn btn-primary btn-round" target="_blank" href="<?php echo site_url('InvoiceBox/'.idencode($id)); ?>">ST Invoice</a>
                                                <a class="btn btn-primary btn-round" target="_blank" href="<?php echo site_url('InvoiceBox2/'.idencode($id)); ?>"> BH Invoice</a>
                                                <a class="btn btn-danger btn-round pull-right" href="<?php echo site_url('Pending'); ?>">Back</a>
