                ...
                <div class="clearfix"></div>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right formarea">
                            <form method="post" action="<?php echo site_url('issued-cleared-bookings'); ?>" id="fliterFormData" class="form-inline">
                        ...
                        <table id="example" class="display nowrap tablColor" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $j; ?></td>
                                    <td align="center"> 
                                      <a target="_blank" class="anchorCustm" href="<?php echo base_url('BookingDetailBox/'.$encodeData.'/'.idencode(2)); ?>"><?php echo idToName('company','id',$obj->company,'company_Code').'-'.$obj->id; ?></a>
