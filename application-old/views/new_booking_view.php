            ...
            <div class="right_col" role="main">
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <a class="btn btn-danger btn-round pull-right" href="<?php echo site_url('Home/index'); ?>">Back</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 table-responsive">
                        <table class="table table-condensed" width="100%">
                            <tr class="trStyle" style="background-color: #eeeeee;">
                                    ...
                                    <div class="input-group"> 
                                        <div class="inner-addon right-addon">
                                            <i class="glyphicon glyphicon-calendar"></i>
                                                <input type="text" name="bookingDateC" id="bookingDateC" value="<?php echo date('Y-m-d'); ?>" class="form-control"  readonly="">
...
<!--                                        <option selected="selected" value="Brightsun Travel">Brightsun Travel</option>
                            ...
                            <tr style="background-color: #eeeeee;">
                                ...
                                <td colspan="3">
                                    <select name="booking_brand" class="form-control" onchange="removeerror('bookingbrandError',this.id)" id="booking_brand">
                                        ...
                                        <option value="<?php echo $ourComy->id; ?>" <?php if($this->session->userdata('company')==$ourComy->id){ ?> selected="selected" <?php } ?> ><?php echo $ourComy->company_name; ?></option>
                                        <?php } ?>
                                        <?php }
                                        else{
                                            ?>
                                        <option value="">--Select One--</option>
                                          ...
                                          {
                                             ?>
                                                <option value="<?php echo $otherCompObj->id ?>" selected="selected"><?php echo $otherCompObj->company_name; ?></option>
                                            <?php 
                                          } 
                                        } ?>
                            ...
                            <tr style="background-color: #eeeeee;">
                                <td colspan="3" class="text-left">
                                    <label class="label txtRed">Paying By:</label>
                                </td>
                                <td colspan="3">
                                	<div class="row">
                                		<div class="col-md-12">
                                            ...
                                            <div id="bookingChargeFor" class="col-md-8" style="display: none;"> 
                                ...
                                <td colspan="3" class="text-left">
                                    <label class="label txtRed">Payment due Date & Time:</label>
                                </td>
                                <td colspan="3">
                                	<div class="input-group"> 
                                        <div class="inner-addon right-addon">
                            ...
                            <tr style="background-color: #eeeeee;">
                                <table class="table table-condensed" width="100%" >
                                    <tr>
                                        ...
                                        <th style="width: 100px"><label class="label">Age <sup>(yrs)</sup></label></th>
                                        <th style="width: 100px"><label class="label">Sale Price(£)</label></th>
                                        <th style="width: 100px"><label class="label">Admin Fee(£)</label></th>
                                        <th style="width: 100px"><label class="label">E-Ticket No.</label></th>
                                    </tr>
