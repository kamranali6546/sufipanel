                    ...
                    <div class="well" style="background-color: #fff; border: 1px solid #636363;">
                        <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12" style="background-color: #f3f3f3;padding: 16px 20px;height: 520px;">
                                    <form method="post" target="_blank" id="reportForm" >
                                    <div class="row">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="input-group"> 
                                              <div class="inner-addon right-addon">
                                                  ...
                                                  <input type="text" class="form-control nextDueDate" readonly="" value="<?php echo date('Y-m-1'); ?>" name="reportStartDate" id="reportStartDate"> 
                                              </div>
                                          </div> 
                            ...
                            <table class="table-hover" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
                               <tbody>
                                  ...
                                  <tr>
                                     ...
                                     <td align="left" style="padding-top: 10px;"><a  href="javascript:report('report-gross-profit-earned',1);" style="color: #0080FF;font-weight: bold;font-size:14px;" target='_blank'>Gross Profit Earned</a></td>
                                     <td width="17%" rowspan="2" align="left" style="padding-top: 10px"><a href="javascript:report('report-gross-profit-earned',2);" target="_blank"><img src="lib/images/excel.png" width="32" height="32" border="0"></a></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                     <td align="left" style="text-align: center">⚫</td>
                                     <td align="left"><a  href="javascript:report('report-net-profit-earned',1);" style="color: #0080FF;font-weight: bold;font-size:14px;" target='_blank'>Net Profit Earned</a></td>
                                  ...
                                  <!--  <tr>
                                     ...
                                     <td width="17%" rowspan="2" align="left"><a href="javascript:report('customer-due-balance',2);"><img src="lib/images/excel.png" width="32" height="32" border="0" /></a></td>
                                     </tr>
                                     <tr>
                                     <td align="left" style="text-align: center">&nbsp;</td>
                                  ...
                                  <tr>
                                     <td align="left" style="text-align: center">⚫</td>
                                     <td align="left"><a  href="javascript:report('report-supplier-due-balance',1);" style="color: #0080FF;font-weight: bold;font-size:14px;" target='_blank'>Supplier Due Balance</a></td>
                                  ...
                                  <tr>
                                     <td align="left" style="text-align: center">⚫</td>
                                     <td align="left"><a  href="javascript:report('report-customer-due-balance',1);" style="color: #0080FF;font-weight: bold;font-size:14px;" target='_blank'>Customer Due Balance</a></td>
                                  ...
                                  <tr>
                                     <td align="left" style="text-align: center">⚫</td>
                                     <td align="left"><a href="<?php echo base_url('PaypalReportBox'); ?>" style="color: #0080FF;font-weight: bold;font-size:14px;" target='_blank'>Paypal Sum Received - Pending Bookings</a></td>
                                  ...
                                  <tr>
                                     <td align="left" style="text-align: center">⚫</td>
                                     <td align="left"><a  href="javascript:report('report-global-card-charges',1);" style="color: #0080FF;font-weight: bold;font-size:14px;" target='_blank'>Global Card Charges</a></td>
                                     <td width="17%" rowspan="2" align="left"><a href="javascript:report('report-global-card-charges',2);" target="_blank"><img src="lib/images/excel.png" width="32" height="32" border="0"></a></td>
                                  </tr>
                                  <tr>
                                     <td align="left" style="text-align: center">&nbsp;</td>
                                  ...
                                  <tr>
                                     <td align="left" style="text-align: center">⚫</td>
                                     <td align="left"><a  href="javascript:report('report-gds',1);" style="color: #0080FF;font-weight: bold;font-size:14px;" target='_blank'>GDS Report</a></td>
                                     <td width="17%" rowspan="2" align="left"><a href="javascript:report('report-gds',2);" target="_blank"><img src="lib/images/excel.png" width="32" height="32" border="0"></a></td>
                                  </tr>
                                  <tr>
                                     <td align="left" style="text-align: center">&nbsp;</td>
...
<script>
    ...
    if(endDate=='')
    {
        ...
        {
            $('#reportForm').attr('action','report-gross-profit-earned-sheet');
            $('#reportForm').submit();
        }
        else if(param=='report-net-profit-earned' && param2=='1')
        {
            $('#reportForm').attr('action','report-net-profit-earned');
             $('#reportForm').submit();
        }
        else if(param=='report-net-profit-earned' && param2=='2')
        {
            $('#reportForm').attr('action','report-net-profit-earned-sheet');
             $('#reportForm').submit();
        }
        else if(param=='report-supplier-due-balance' && param2=='1')
        {
            $('#reportForm').attr('action','report-supplier-due-balance');
            $('#reportForm').submit();
        }
        else if(param=='report-supplier-due-balance' && param2=='2')
        {
            $('#reportForm').attr('action','report-supplier-due-balance-sheet');
            $('#reportForm').submit();
        }
        else if(param=='report-customer-due-balance' && param2=='1')
        {
            $('#reportForm').attr('action','report-customer-due-balance');
            $('#reportForm').submit();
        }
        else if(param=='report-customer-due-balance' && param2=='2')
        {
            $('#reportForm').attr('action','report-customer-due-balance-sheet');
            $('#reportForm').submit();
        }
        else if(param=='report-global-card-charges' && param2=='1')
        {
            $('#reportForm').attr('action','report-global-card-charges');
            $('#reportForm').submit();
        }
        else if(param=='report-global-card-charges' && param2=='2')
        {
            
            $('#reportForm').attr('action','report-global-card-charges-sheet');
            $('#reportForm').submit();
        }
        else if(param=='report-gds' && param2=='1')
        {
            $('#reportForm').attr('action','report-gds');
            $('#reportForm').submit();
        }
        else if(param=='report-gds' && param2=='2')
        {
            $('#reportForm').attr('action','report-gds-sheet');
            $('#reportForm').submit();  
        }
    }
