...
#drEntryModelEdit .row, #crEntryEditModel .row {
	margin-bottom: 14px !important; 
}
	.input-group {
		display: inherit;
...
<div id="addBank" class="modal fade" role="dialog">
	<div class="modal-dialog"> 
		...
		<div class="modal-content">
			...
			<div class="modal-footer"> 
				<button type="button" id="BankBtn" onclick="bankSave()" class="btn btn-success">Save</button>
		  ...
		  <div class="form-group">
			<div class="row">  
				<div class="col-md-6">
					...
					<input type="text" name="" onkeypress="removeerror('supplierNameError',this.id);" id="supplierName" class="form-control" placeholder="Create Liability Name">
					<span id="supplierNameError"></span>
				</div> 
				<div class="col-md-6">
					<div class="form-group">
						<label>Bank of Liability:</label>
						<input type="text" name="supplierBank" id="supplierBank" placeholder="Enter Bank of Liability" class="form-control" >
			...
			<div class="row">
				<div class="col-md-6">
					...
					<input type="radio" name="supplierType"  value="deposit">Indirect <br>
					<input type="radio" name="supplierType"  value="full_pay">Direct<br>
...
<!--                                <label>Select Account Type:</label>
		...
		<div class="modal-footer">
			<button type="button" id="supplierBtn" onclick="supplierSave()" style="position: relative;top: 3px;" class="btn btn-success">Save</button>
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div>
	  </div> 
	  </form>
...
<!-- Add Transaction Modal Receipts from Customer Start -->
	<div class="modal fade" id="transectionModalForCustomer" role="dialog">
		<div class="modal-dialog modal-lg">
		  <!-- Modal content-->
			<div class="modal-content">
				<form  class="" method="post"  id="transectionCustomerForm" >
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">Add Transaction</h4>
				</div>
													...
													<td>
															...
															<div id="debitEntryModel">
																<div class="row" id="drModel1">
																	<div class="col-lg-6"> 
																		<label for="">To (Dr.): &nbsp;</label>
																		<select name="dr_pay_to[]" id="drDropDownId"  class="form-control">
																			<option value="">--Select One--</option>
																			<?php if(!empty($supplierData)){ foreach($supplierData as $supplierObjDr){ ?>
														...
														<input type="hidden" id="crCountModel" value="1">
															<div id="crEntryModel">
																<div class="row" id="crModel1">
																	<div class="col-lg-6"> 
																		<label for="">By (Cr.): &nbsp;</label>
																		<select name="cr_pay_by[]" id="crDropDownId" class="form-control">
																			<option value="">--Select One--</option>
																			<?php if(!empty($supplierData)){ foreach($supplierData as $supplierObjCr){ ?>
...
<div class="modal fade success" id="expenseModal" role="dialog">
	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
		  ...
		  <div class="form-group">
			<div class="row">  
				<div class="col-md-6">
					...
					<input type="text" name="" onkeypress="removeerror('expenseHeadNameError',this.id);" id="expenseHeadName" class="form-control" placeholder="Create Expense Name">
		...
		<div class="modal-footer">
			<button type="button" id="expenseBtnSave" onclick="expenseHeadSave()" style="position: relative;top: 3px;" class="btn btn-success">Save</button>
			<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
		</div>
	  </div> 
	  </form>
...
<!-- Edit Transaction Modal Receipts from Customer Start -->
	<div class="modal fade table-drcr" id="EditTransaction" role="dialog">
		<div class="modal-dialog modal-lg"> 
		  <!-- Modal content-->
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div id="drEntryModelEdit">
						<div class="row" id="drModel1">
							<div class="col-lg-6">
								...
								<select name="dr_pay_to_Edit[]" id="dr_pay_to_Edit"  class="form-control">
									<option value="">--Select One--</option>
									<?php if(!empty($supplierData)){ foreach($supplierData as $supplierObjDr){ ?>
										<option value="<?php echo $supplierObjDr->supplier_name.'-supplier'; ?>"><?php echo $supplierObjDr->supplier_name.'  -  '. idToName('bank','id',$supplierObjDr->BankId,'bank_name'); ?></option>
									<?php } } ?>
								...
								<input type="text" name="dr_booking_refEdit[]" id="drBookingRefEdit"  class="form-control"> 
                                        ...
                                        <div class="row" style="margin-top:8px;">
                                            <div class="col-lg-3 col-lg-offset-6">
                                                    <label for="">Dr. Total &nbsp;</label>
                                                    <label for="" class="text-right" id="edittrsDrSum"></label> 
                                            </div>
                                        </div>
                                        <br><br>
					<div class="form-group">
					...
					<div id="crEntryEditModel">
						<div class="row" id="crEditModel1">
							<div class="col-md-6"> 
								<label for="">By (Cr.): &nbsp;</label>
								<select name="cr_pay_by_Edit[]" id="cr_pay_to_Edit" class="form-control">
									<option value="">--Select One--</option>
									<?php if(!empty($supplierData)){ foreach($supplierData as $supplierObjCr){ ?>
										<option value="<?php echo $supplierObjCr->supplier_name.'-supplier'; ?>"><?php echo $supplierObjCr->supplier_name.'  -  '. idToName('bank','id',$supplierObjCr->BankId,'bank_name'); ?></option>
									<?php } } ?>
							...
							<div class="col-md-3"> 
								<label for="">Amount (&pound;): &nbsp;</label>
								<input type="text" name="cr_amountEdit[]" onkeyup="crTotalCount(this.value,'editTrsCrSum')" id="crAmountEdit"  class="form-control"> 
							</div>
							<div class="col-md-3"> 
								...
								<input type="text" name="cr_booking_refEdit[]" id="bookingRefCrEdit" class="form-control"> 
                                        ...
                                        <div class="row" style="margin-top:8px;">
                                            <div class="col-md-3 col-lg-offset-6">
                                                    <label for="">Cr. Total &nbsp;</label>
                                                    <label for="" class="text-right" id="editTrsCrSum">0</label>
                                            </div>
					</div>
					<br><br>
					<div class="form-group">
...
<!--                            <div class="form-group">
							...
							<div class="form-group">
								...
								<!-- <textarea id="editor" name="sendReceipt" class="form-control"> -->
									<div class="row">
										<div class="col-md-12">
											<div class="richText-editor" id="richText-moowvw-Agent" contenteditable="true" style="width:100%;height: 300px;overflow-y: scroll; border: 1px solid #d2d2d2;border-left: 3px solid blue;padding: 10px;">
