...
<!--                    <div class="navbar nav_title" style="border: 0;">
                    ...
                    <div class="profile">
                        ...
                        <div class="profile_info">
                            ...
                            <div><b>Uk Time: </b> <span id="WelTimeplace"><script>window.load=welTimeShow()</script></span></div>
                    ...
                    <?php  if($this->session->userdata('company')==1 && $this->session->userdata('flag')==1){ ?>
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li class="<?php if(!empty($tab)){ if($tab==''){ echo "current-page"; } } ?>"><a href="<?php echo site_url('Booking'); ?>"><i class="fa fa-ticket" aria-hidden="true"></i>New Booking <span class="NumLabel"><?php echo countTotal('booking_details',array('booking_date'=>date('Y-m-d'))); ?></span></a></li>
                                ...
                                <li class="<?php if(!empty($tab)){ if($tab=='redFlag'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('pending-bookings-red-flag'); ?>"><i class="fa fa-flag-checkered" aria-hidden="true"></i>Red Flag Bookings<span class="NumLabel"><?php if($this->session->userdata('flag')==1){ echo countTotal('booking_details',array('red_flag'=>'1')); } else{ echo countTotal('booking_details',array('red_flag'=>'1','booked_agent_id'=>$this->session->userdata('userId'))); } ?></span></a></li>
                                ...
                                <li class="<?php if(!empty($tab)){ if($tab=='pendingTask'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('pending-task'); ?>"><i class="fa fa-tasks" aria-hidden="true"></i>Pending Task<span class="NumLabel"><?php if($this->session->userdata('flag')==1){ echo (countTotal('paymentRequest',array('isRead'=>0))+ countTotal('ticketOrderRequest',array('isRead'=>0))); }  ?></span></a></li>
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="<?php echo site_url('picked'); ?>"><i class="fa fa-truck" aria-hidden="true"></i> Day wise Summary <span class="NumLabel"><?php if($this->session->userdata('flag')==1){ echo  todayFollowUpDayWiseCount(); } ?></span></a>
                                <li><a href="<?php echo site_url('Receival-Summary'); ?>"><i class="fa fa-truck" aria-hidden="true"></i> Receival Summary <span class="NumLabel"><?php echo receivalCount(); ?></span></a>
                                <li><a href="<?php echo site_url('NewFollowUP'); ?>"><i class="fa fa-pencil" aria-hidden="true"></i>Create Follow-up <span class="NumLabel"><?php echo todayFollowUpCount(); ?></span></a>
                                ...
                                <li><a href="<?php echo site_url('converstion'); ?>"><i class="fa fa-exchange"></i>Sale Conversion <span class="NumLabel"><?php echo bookingConversionCount($this->session->userdata('flag'),''); ?></span></a>
                            </ul>
                        </div>
                        <div class="menu_section">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                 ...
                                 <li class="<?php if(!empty($tab)){ if($tab=='expense'){ echo "current-page"; } } ?>" ><a href="<?php echo site_url('uk-Expenditures'); ?>"><i class="fa fa-money" aria-hidden="true"></i>UK Expenditures<span class="NumLabel"><?php echo expenditureCount(); ?></span></a></li> 
                         ...
                         <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li class="<?php if(!empty($tab)){ if($tab=='reports'){ echo "current-page"; } } ?>" ><a href="<?php echo site_url('GeneralReportBox'); ?>"><i class="fa fa-file" aria-hidden="true"></i>General Reports<span class="NumLabel"><?php echo generalReportCount(); ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='progressSheet'){ echo "current-page"; } } ?>" ><a href="<?php echo base_url('Home/index'); ?>"><i class="fa fa-tasks" aria-hidden="true"></i>Progress Sheet<span class="NumLabel"><?php echo progressSheetCount(); ?></span></a></li>
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li class="<?php if(!empty($tab)){ if($tab=='agents'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('User'); ?>"><i class="fa fa-user"></i>Logins <span class="NumLabel"><?php echo countLoginArea(); ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='company'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('Agencies'); ?>"><i class="fa fa-building"></i>Brands<span class="NumLabel"><?php echo countTotal('company',array('flag'=>'1')) ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='bank'){ echo "current-page"; }} ?>"><a href="<?php echo site_url('BankBoxAll'); ?>"><i class="fa fa-institution"></i>Assets<span class="NumLabel"><?php echo countTotal('bank',array('flag'=>'1'))+countTotal('bank',array('flag'=>'0')); ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='expenditure'){ echo "current-page"; }} ?>"><a href="<?php echo site_url('ExpenseBox'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Expenses<span class="NumLabel"><?php echo countTotal('expense_head',array('flag'=>1)) + countTotal('expense_head',array('flag'=>0)); ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='supplier'){ echo "current-page"; }} ?>"><a href="<?php echo site_url('SupplierBox'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Liabilities<span class="NumLabel"><?php echo countTotal('suppliers',array('flag'=>'1'))+countTotal('suppliers',array('flag'=>'0')) ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='income'){ echo "current-page"; }} ?>"><a href="<?php echo site_url('IncomeBox'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Income/Revenue<span class="NumLabel"><?php echo countTotal('income_head',array('flag'=>'1')); ?></span></a></li>
                    ...
                    <?php } 
                    else if($this->session->userdata('company')==1 && $this->session->userdata('flag')==2)
                    {
                        ?>
                         <div class="menu_section">
                            <h3 style="text-transform: capitalize;font-size: 20px;padding-top: 12px;">Booking Panel</h3>
...
<!--                            <br>
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li class="<?php if(!empty($tab)){ if($tab=='fourtypercent'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('pending-bookings-fourty-percent-or-above'); ?>"><i class="fa fa-percent" aria-hidden="true"></i>Paid 40% Or Above<span class="NumLabel"><?php echo paidFortyPerCount($this->session->userdata('flag'),$this->session->userdata('userId')); ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='redFlag'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('pending-bookings-red-flag'); ?>" ><i class="fa fa-flag-checkered" aria-hidden="true"></i>Red Flag Bookings<span class="NumLabel"><?php  echo countTotal('booking_details',array('red_flag'=>'1'));  ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='issued'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('issued-bookings'); ?>"><i class="fa fa-clock-o" aria-hidden="true"></i>Issued Uncleared<span class="NumLabel"><?php if($this->session->userdata('flag')==1){ echo countTotal('booking_details',array('flag'=>'2','cleared_stat'=>'0')); } else{ echo countTotal('booking_details',array('flag'=>'2','booked_agent_id'=>$this->session->userdata('userId'),'cleared_stat'=>'0')); } ?></span></a></li>
                                ...
                                <li class="<?php if(!empty($tab)){ if($tab=='canceled'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('Canceled'); ?>"><i class="fa fa-clock-o" aria-hidden="true"></i>Cancelled Bookings<span class="NumLabel"><?php if($this->session->userdata('flag')==1){ echo countTotal('booking_details',array('flag'=>'1')); } else{ echo countTotal('booking_details',array('flag'=>'1','booked_agent_id'=>$this->session->userdata('userId'))); } ?></span></a></li>
                                <li class="<?php if(!empty($tab)){ if($tab=='search'){ echo "current-page"; } } ?>"><a href="<?php echo site_url('search-booking'); ?>"><i class="fa fa-search" aria-hidden="true"></i>Search Booking<span class="NumLabel">new</span></a></li>
                        ...
                        <div class="menu_section">
                         ...
                         <div class="menu_section">
                            <h3 style="text-transform: capitalize;font-size: 20px;padding-top: 12px;">Reportings</h3>
                            <ul class="nav side-menu">
                                <li><a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i>General Reports<span class="NumLabel"><?php echo generalReportCount(); ?></span></a></li>
                            </ul>
                         </div>
                        <?php 
                    }
