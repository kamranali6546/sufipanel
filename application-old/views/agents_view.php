...
<div class="modal fade success" id="editAgent" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="agentEditForm" method="post" action="<?php echo site_url('UserSave'); ?>" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                         <label>CNIC#:</label>
                                         <input type="text" id="cnicEdit" name="cnicEdit" value="<?php echo set_value('cnic'); ?>" class="form-control" tabindex="5" >
