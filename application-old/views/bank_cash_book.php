            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form action="<?php echo base_url('bank-cash-book'); ?>" method="post" class="form-inline">
                            <div class="row">
...
<!--                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <select name="bank" class="form-control" style="width:100% !important;">
                                        <option value="">Select</option>
                                        <?php if(!empty($bankHead)){ foreach ($bankHead as $bObj){ ?>
                                        <option value="<?php echo $bObj->bank_name.'-bank'; ?>" <?php if($bHead){ if($bHead==$bObj->bank_name){ ?>selected="selected" <?php } } ?> ><?php echo 'Bank-'.$bObj->bank_name; ?></option>
                                        <?php } } ?>
