<title>New Pk Transaction</title>
<style>
    .bdrBtm {
...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-10">
            <form  class="" method="post" id="transectionFormPk" >
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <!--<form action="" class="formInlineFlex">-->
                                            <div class="row">
                                                <div class="col-md-3 col-md-offset-6"> 
                                                    ...
                                                    <label for="" class="text-left text-muted" id="genTrsnDrSum">0</label> 
                                                </div> 
                                            </div> 
                                        <!--</form>-->
                                    </td>
                                        ...
                                        <!--<form action="" class="formInlineFlex">-->
                                            <div class="row" style="margin-top: 10px;">
                                                <div class="col-lg-3 col-md-offset-6"> 
                                                    ...
                                                    <label for="" class="text-left text-muted" id="genTrnsCrSum">0</label>
                                                </div> 
                                            </div> 
                                        <!--</form>-->
                                    </td>
...
<script>
    function addDebit()
    {
        ...
        $.ajax({
            type:'post',
            url:ajaxUrl+'dr-more-pk-transection-html',
...
//        alert('Under Developed');
        ...
        $.ajax({
            type:'post',
            url:ajaxUrl+'cr-more-pk-transection-html',
...
//    }
    $("#transectionFormPk").on('submit',(function(e) {
         e.preventDefault();
         $.ajax({
        	url: ajaxUrl+'Transection/makeTransectionPk',
                type: "POST",
