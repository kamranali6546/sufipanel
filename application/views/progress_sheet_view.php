...
<!--                 <label for="">Month:</label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <select name="brand" class="form-control" style="width: 100%;">
                            ...
                            if(!empty($copany))
                            {
                                ...
                                {
                                    if($this->session->userdata('flag')==3 && $this->session->userdata('company')==$cObj->id)
                                    {
                                        ?>
                                    ...
                                    {
                                     if($this->session->userdata('company')==$cObj->id)
                                      { ?>
                                         <option <?php if(!empty($brandFliter) && $cObj->id==$brandFliter){ ?> selected="selected" <?php } ?> value="<?php echo $cObj->id; ?>"><?php echo $cObj->company_name; ?></option>
                                      <?php }   
                                    }
                    ...
                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                        <button type="submit" class="btn btn-info btnmargin-mob">Submit</button> 
                    </div>
...
<!--                    <tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td align="left" style="font-weight: bold; border-bottom: 2px solid #EBEBEB;"><?php echo $totalNewBooking; ?> <span style="font-size:10px; color:#999;">/ <?php echo $totalAgentBookingTarget; ?> </span></td>
                        ...
                        <td align="left" style="font-weight: bold; border-bottom: 2px solid #EBEBEB;">
