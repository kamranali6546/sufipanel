            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                <div class="input-group"> 
                            <div class="inner-addon right-addon">
                                ...
                                <input type="text" class="form-control nextDueDate" readonly="" value="<?php echo date('Y-m-01'); ?>" name="startDate" > 
                            </div>
                        </div> 
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                ...
                <div class="input-group"> 
                            <div class="inner-addon right-addon">
                                <i class="glyphicon glyphicon-calendar"></i>
                                <input type="text" class="form-control nextDueDate" readonly="" value="<?php echo date('Y-m-d'); ?>" name="endDate"> 
                            </div>
                        </div> 
            </div>
			...
			<table class="display table-hover tablColor" width="100%" cellspacing="0">
				<thead>
					<tr>
                        ...
                        <th>Set Reminder</th>
						<th style="min-width:130px;text-align: center !important;">Actions</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td><a data-toggle="modal" data-target="#inquirydetails<?php echo $obj->iid; ?>" href="<?php //echo base_url('details/'.idencode($obj->iid)) ?>" title="<?php //echo $obj->customer_email ?>"><?php echo $obj->iid; ?></a></td>
                                                <td><span style="font-weight: 600;">Flight Search :</span> <?php echo $obj->name;  ?>-<?php  $destion=explode('-',$obj->destination); echo $destion[0]; ?> <small class="text-muted" style="font-size:10px;"><?php echo $obj->brand_code; ?>:<?php echo originInquiry($obj->inquiry_regin); ?>,  <?php echo $obj->device.' : '.$obj->os; ?></small></td>			
...
<!--                            <div class="input-group"> 
                                        <div class="inner-addon right-addon">
                                            <i class="glyphicon glyphicon-calendar"></i>
                                                <input type="text" name="paymentDueDate"  onclick="removeerror('paymentDueDateError',this.id)" class="form-control" >
						...
						<td style="text-align:center !important;">
							...
							<?php if($this->session->userdata('flag')=='1' || $this->session->userdata('flag')=='2'){ ?>
							<a href="javascript:void(0)" onclick="inquiryDelete2(<?php echo $obj->iid ?>)" title="Delete" data-toggle="tooltip" type="button" class="btn btn-xs btn-danger btn-round"><i class="fa fa-trash-o"></i></a>
					...
					<?php $j++;
                                        ...
                                        <div class="modal fade" id="inquirydetails<?php echo $obj->iid; ?>" role="dialog">
                                            ...
                                            <div class="modal-dialog  modal-lg">
                                              <!-- Modal content-->
                                              <form method="post" id="formIqueryUpdate-<?php echo $obj->iid; ?>" action="<?php echo base_url('FlowupUpdaeBox'); ?>">
                                                  <input type="hidden" name="id" value="<?php echo idencode($obj->iid); ?>">
                                              <div class="modal-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label style="font-weight:normal !important;"><?php echo date('d-M-y h:m:i',strtotime($obj->picked_time)); ?></label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <button type="button" onclick="sendUpdateInqueryRequest('<?php echo $obj->iid; ?>')" class="btn btn-primary" >update</button>
                                                </div>
                                              </div>
...
<script>
    function sendUpdateInqueryRequest(idIng)
   {
     $('#formIqueryUpdate-'+idIng).submit();  
   }
