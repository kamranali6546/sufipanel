...
//                           $receiveCount_cancel=totalreceivedAmount($cancleObj->id);
                           ...
                           $amountGotoCustomer=getQueryRes('select  sum(amount) as total  from payment  where booking_ref='.$cancleObj->id.' AND pay_type="Dr" AND pay_to="Customer" AND payment_nature!="expense" AND pay_by!="Profit & Loss on Cancellations-UK" ');
      ...
      <table class="text-black" align="center" width="95%" style="font-size: 14px !important;">
         <tbody>
            ...
            <tr>
               ...
               <td width="9%" align="center" style="font-weight:bold; font-size:16px;"><?php  $driectorAmount=(($netPro*12)/100); echo number_format($driectorAmount,2); ?></td>
            </tr>
            <tr>
               <td align="right" style="font-weight:bold; font-size:16px;">&nbsp;</td>
