...
<div class="right_col" role="main">
    ...
    <div class="row">
        ...
        <div class="col-md-12 table-responsive">
            <h4 style="color:#000;font-weight:bold;margin-bottom: 3px;">Payments & Others</h4>
...
//                            echo "</pre>";
                         ...
                         if($this->session->userdata('flag')==3){
                             if($companyId==$this->session->userdata('company')){
                        ?>
                    <tr>
                        <td><?php echo $paySr; ?></td>
                        <td><?php echo $paymentObj->entrydate; ?></td>
                        <td class="text-center"><a href="<?php echo site_url('BookingDetailBox/'.idencode($paymentObj->booking_id).'/'.idencode($bookingFlag)); ?>" target="_blank" class="text-blue"><?php echo $ref; ?></a></td>
                        <td class="text-center"><?php echo idToName('admin','id',$paymentObj->requestFrom,'login_name'); ?></td>
                        ...
                        <td>
                            <div class="input-group"> 
                                <div class="inner-addon right-addon">
                                    ...
                                    <input type="text" class="form-control nextDueDate" value="<?php echo $paymentObj->requestDate; ?>"  > 
                                </div>
                            </div>   
                        </td>
                        <td>
                            <input type="text" class="form-control" style="width:70px !important;text-align: center !important;" value="<?php echo $paymentObj->requestAmount; ?>">
                        </td>
                        <td>
                        ...
                        <td> 
                            ...
                            <button type="button" class="btn btn-primary btn-sm" onclick="addPaymentModelFromPendingTask(<?php echo $paymentObj->booking_id ?>,'true',<?php echo $paymentObj->id  ?>,<?php echo $paymentObj->requestAmount ?>,'<?php echo $paymentObj->requestType ?>')" title="Confirm Payment"><i class="fa fa-check-square-o" aria-hidden="true"></i></button>
    ...
    <div class="row">
        ...
        <div class="col-md-12 table-responsive">
            <h4 style="color:#000;font-weight:bold;margin-bottom: 3px;margin-top: 30px;">Invoice Request</h4>
            <table class="display nowrap tablColor dataTable" width="100%" cellspacing="0">
                <thead>
                     <tr>
                        ...
                        <?php if($this->session->userdata('flag')==1 || $this->session->userdata('flag')==2){ ?>
                        <th class="text-center" style="min-width: 130px;">Actions</th> <?php } ?>
                    </tr>
                </thead>
                <tbody> 
                    <?php if(!empty($InvoiceDataRequest)){
                        ...
                        foreach($InvoiceDataRequest as $invoiceObj){
                            if($invoiceObj->requestType=='Invoice'){
                                ...
                                if($this->session->userdata('flag')==3){
                                    if($this->session->userdata('company')==$companyId){
                        ?>
                        <tr>
                            <td><?php echo $insr; ?></td>
                            ...
                            <td>
                                <div class="input-group"> 
                                    <div class="inner-addon right-addon">
                                        <i class="glyphicon glyphicon-calendar"></i>
                                        <input type="text" class="form-control nextDueDate" value="<?php echo $invoiceObj->requestDate; ?>"  > 
                                    </div>
                                </div>   
                            </td> 
                            <td>
                        ...
                        <td> 
                            <button type="button" class="btn btn-primary btn-sm" title="Confirm Payment"><i class="fa fa-check-square-o" aria-hidden="true"></i></button> 
    ...
    <div class="row">
        ...
        <div class="col-md-12 table-responsive">
            <h4 style="color:#000;font-weight:bold;margin-bottom: 3px;margin-top: 30px;">Cancelled Files Request</h4>
            <table class="display nowrap tablColor dataTable" width="100%" cellspacing="0">
                <thead>
                     <tr>
                        <th>S.No</th>
                        <th style="min-width: 70px;">Requested<br>Date</th>
                        <th style="min-width: 70px;">Ref<br> No.</th>
                        <th>Request <br>By</th> 
                        <th style="min-width: 100px;">Supplier <br> Ref.</th> 
                    ...
                    <tr>
                        ...
                        <td>
                            <div class=""> 
                                <div class="inner-addon right-addon">
                                    <i class="glyphicon glyphicon-calendar"></i>
                                    <input type="text" class="form-control nextDueDate" value="<?php echo $cancelReq->requestDate; ?>" > 
                                </div>
                            </div>   
                        </td>
                        <td style="margin: 0px;padding: 0px;">
                            <input type="text" class="" style="text-align:center;height:28px;width:70px !important;margin:0px !important;padding: 0px !important;" value="<?php echo $cancelReq->requestAmount; ?>">
                        </td>
                        <td>
    ...
    <div class="row">
        ...
        <div class="col-md-12 table-responsive">
            <h4 style="color:#000;font-weight:bold;margin-bottom: 3px;margin-top: 30px;">Refund to Customer Request</h4>
            <table class="display nowrap tablColor dataTable" width="100%" cellspacing="0">
                <thead>
                     <tr>
                        <th>S.No</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group"> 
                                <div class="inner-addon right-addon">
                                    <i class="glyphicon glyphicon-calendar"></i>
                                    <input type="text" class="form-control nextDueDate" value="<?php echo $customerRefObj->requestDate; ?>" > 
                                </div>
                            </div>   
                        </td>
                        <td style="margin: 0px;padding: 0px;"> 
                            <input type="text" class="" style="text-align:center;height:28px;width:70px !important;margin:0px !important;padding: 0px !important;" value="<?php echo $customerRefObj->requestAmount; ?>">
                        </td>
                        <td>
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" onclick="confirmRefundModal(<?php echo $customerRefObj->booking_id ?>,<?php echo $customerRefObj->requestAmount ?>,<?php echo $customerRefObj->id ?>,'true')" title="Confirm Payment" class="btn btn-primary btn-sm"><i class="fa fa-check-square-o" aria-hidden="true"></i></button> 
    ...
    <div class="row">
        ...
        <div class="col-md-12 table-responsive">
            <h4 style="color:#000;font-weight:bold;margin-bottom: 3px;margin-top: 30px;">Airline Refund Request</h4>
            <table class="display nowrap tablColor dataTable" width="100%" cellspacing="0">
                <thead>
                     <tr>
                        <th>S.No</th>
                        ...
                        <th style="min-width: 80px;">Refund<br>Date</th>
                        <th style="min-width: 80px;">Amount</th>
                        <th style="min-width: 50px;">Ref</th>
                        <?php if($this->session->userdata('flag')==1 || $this->session->userdata('flag')==2){ ?>
                        <th class='text-center' style="min-width: 85px;">Actions</th> <?php } ?>
                    </tr>
                </thead>
                <tbody> 
                    <?php  if(!empty($AirlineRefundRequest)){
                        ...
                        <tr>
                            ...
                            <td>
                                <div class=""> 
                                    <div class="inner-addon right-addon">
                                        <i class="glyphicon glyphicon-calendar"></i>
                                        <input type="text" class="form-control nextDueDate" value="<?php echo $airlineRefObj->requestDate; ?>" > 
                                    </div>
                                </div>   
                            </td>
                            <td> 
                                <input type="text" class="" style="text-align:center;margin: 0px;padding: 2px !important;height: 29px;width: 64px;" value="<?php echo $airlineRefObj->requestAmount; ?>"> 
                            </td>
                            <td>
...
<!--    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-12 table-responsive">
            <h4 style="color:#000;font-weight:bold;margin-bottom: 3px;margin-top: 30px;">Tickets</h4>
            <table class="display nowrap tablColor dataTable" width="100%" cellspacing="0">
                <thead>
                     <tr>
                        <th>S.No</th>
                ...
                <tbody> 
                    <?php if(!empty($ticketorder)){ $tickerOrdSr=1; foreach ($ticketorder as $ticketOrdObj){ 
                        ...
                        $pickagentid =idToName('booking_details','id',$ticketOrdObj->booking_id,'booked_agent_id');
                        $agentnamearsalan=idToName('admin','id',$pickagentid,'login_name');
                         ...
                         if($this->session->userdata('flag')==3){
                             if($this->session->userdata('company')==$companyIdticketOrder){
                        ?>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control text-center" value="<?php echo $ticketOrdObj->issueCost; ?>">
                        </td>
                        <td><textarea class="form-control" rows="2" ><?php echo $ticketOrdObj->message; ?></textarea></td>
                            ...
                            { ?>
                             <tr>
                                    ...
                                    <td><?php echo $ticketOrdObj->priorty; ?></td>
                                    <td><a href="<?php echo site_url('BookingDetailBox/'.idencode($ticketOrdObj->booking_id).'/'.idencode($bookingFlagTicketOrder)); ?>" class="text-blue" target="_blank"><?php echo $refTicket; ?></a></td>
                                    <td><?php echo $agentnamearsalan ?></td>
                                    <td><?php echo $ticketOrdObj->supplierName; ?></td>
                                    <td><?php echo $ticketOrdObj->supplierEmail; ?></td>
                                    <td><?php echo $ticketOrdObj->supplierReference; ?></td>
                                    <td><?php echo $ticketOrdObj->gds; ?></td>  
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm" title="Ticket Order" onclick="sendTicketOrderEmailReady(<?php echo $ticketOrdObj->booking_id ?>)" ><i class="fa fa-file-text-o" aria-hidden="true"></i></button> 
                                        <button type="button" class="btn btn-primary btn-sm" title="Issue Ticket" onclick="issueBookingLoad(<?php echo $ticketOrdObj->booking_id ?>)"><i class="fa fa-check" aria-hidden="true"></i></button>  
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12"> 
                            ...
                            <div class="form-group">
                                <label>Message:</label> 
                                <input type="hidden" name="messageInn22" id="messageInn22">
                                <textarea name="messageInn" class="contentTicketOrderEditor" id="messageInn"></textarea>
