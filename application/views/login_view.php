...
<div class="container">
    <div class="row">
        <div class="col-lg-12 main"> 
        	<div class="row" style="background: #f2f0f0">
                <?php
//                                     echo "<pre>";
//                                     print_r($weather);
//                                    $main= $weather['weather'][0]['main'];
        		...
        		<div class="col-lg-4 left">
        			...
        			<img src="<?php echo LINK ?>images/sufilogo.png">
        			<h2 class="text-center">Agents Panel</h2>
        			<h4 class="text-center">Sufi Travel & Tours Ltd. | All right reversed</h4>
                    <br><br>
                    <div class="row"> 
                            ...
                            <div class="col-lg-2 col-xs-6">
                                ...
                                <div class="col-lg-2 col-xs-6">
                                    <ul class="list-inline" style="margin-left: 10px;"><br>
                                        <li class="list-inline-item"><i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo date('D'); ?></li>
                                    </ul>
                                </div>
                                    <ul class="list-inline" style="margin-left: 10px;"><br>
                        ...
                        <div class="col-lg-2 col-xs-3 hidden-xs">
                                            <img style="height: 80px;" src="<?php echo LINK ?>images/10d.png">
                        </div>
                        <div class="col-lg-6 col-xs-6 hidden-xs" style="text-align: initial;">
                            <h4 style="margin-top: 0px;"><?php echo $name; ?></h4>
                            <H5 class="m-0">United Kingdom</h5>
                                                <h4 class="m-0"><?php echo $temparture; ?>&deg;C</h4>
                            <h5 class="m-0"><?php echo $main; ?></h5>
                            <p class="m-0" style="font-size: 12px">High: <?php echo $maxtemparture; ?>&deg;C &nbsp;&nbsp; Low:<?php echo $mintemparture; ?>&deg;C</p>
                        </div>
                    </div>
        		</div>
        		<div class="col-lg-8 right" style="background: white;">
        			<div class="row">
        				...
        				<div class="col-lg-12">
                            <p class="text-center" style="margin-top: 25px; font-size: 20px">﷽</p>
        					<p class="text-center">In the name of ALLAH, the most Beneficient & the most Merciful.</p>
        					<!-- <h4 class="AYD text-center">Ayat al-Kursi</h4> -->
        					 
                                        <p class="text-center" style="font-size: 16px">اللَّهُ لاَ إِلَهَ إِلاَّ هُوَ الْحَيُّ الْقَيُّومُ لاَ تَأْخُذُهُ سِنَةٌ وَلاَ نَوْمٌ لَهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الأَرْضِ مَنْ ذَا الَّذِي يَشْفَعُ عِنْدَهُ إِلاَّ بِإِذْنِهِ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ وَلاَ يُحِيطُونَ بِشَيْءٍ مِنْ عِلْمِهِ إِلاَّ بِمَا شَاءَ وَسِعَ كُرْسِيُّهُ السَّمَاواتِ وَالأَرْضَ وَلاَ يَئُودُهُ حِفْظُهُمَا وَهُوَ الْعَلِيُّ الْعَظِيمُ
                            </p>               
                            <p class="text-center" style="font-size: 12px">Allah - there is no deity except Him, the Ever-Living, the Sustainer of [all] existence. Neither drowsiness overtakes Him nor sleep. To Him belongs whatever is in the heavens and whatever is on the earth. Who is it that can intercede with Him except by His permission? He knows what is [presently] before them and what will be after them, and they encompass not a thing of His knowledge except for what He wills. His Kursi extends over the heavens and the earth, and their preservation tires Him not. And He is the Most High, the Most Great.</p>
                                </div>
        			</div><br>
        			 
        			<div class="row ">
        				<div class="col-lg-12">
        					<h2 class="AYD">Welcome to your account!</h2>
        				</div>
        			</div>
        			<div class="row ">
        				<div class="col-lg-12">
